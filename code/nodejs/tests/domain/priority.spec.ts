...
describe('Priority', () => {
    ...
    describe('constructor', () => {
        ...
        it('should use default priority and random cohort if none provided', () => {
        ...
        it('should set value correctly when priority is given', () => {
        ...
        it('should set value correctly when priority and cohort are given', () => {
